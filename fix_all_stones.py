...
def fix_all_stones():
    ...
    # Full data from all images (Pages 1 to 6)
    # Tuple: (code, cut_code, cut_name, model_code, model_name, stone_type, short_code, weight_from, weight_to, size_mm, price)
    data = [
        # Page 1
        (1, 'MQ', 'Marquise', 'M10', 'Model 10', 'MQ .10', 'MQ', '0.080', '0.120', '0.000', '950.00'),
        (2, 'MQ', 'Marquise', 'M3c', 'Model 3c', 'MQ.03', 'MQ', '0.010', '0.030', '0.000', '950.00'),
        (3, 'MQ', 'Marquise', 'M5c', 'Model 5c', 'MQ.05', 'MQ', '0.050', '0.075', '0.000', '950.00'),
        (4, 'PE', 'Pear', 'P3c', 'Model 3c', 'PEAR.03', 'PE', '0.010', '0.030', '0.000', '950.00'),
        (5, 'PE', 'Pear', 'P10', 'Model 10', 'Pear.10', 'Pe', '8.000', '0.120', '0.000', '950.00'),
        (6, 'MQ', 'Marquise', 'M15', 'Model 15', 'MQ.15', 'MQ', '0.135', '0.170', '0.000', '950.00'),
        (7, 'MQ', 'Marquise', 'M20', 'Model 20', 'MQ.20', 'MQ', '0.180', '0.230', '0.000', '950.00'),
        (8, 'MQ', 'Marquise', 'M25', 'Model 25', 'MQ.25', 'MQ', '0.240', '0.280', '0.000', '950.00'),
        (9, 'PE', 'Pear', 'P5c', 'Model 5c', 'Pear.05', 'Pe', '0.035', '0.075', '0.000', '950.00'),
        (10, 'PE', 'Pear', 'P15', 'Model 15', 'Pear.15', 'Pe', '0.130', '0.180', '0.000', '950.00'),
    ...
    for item in data:
        ...
        print(f"Verified/Updated stone code: {code}")
